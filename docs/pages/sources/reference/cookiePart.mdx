...
Extends `KeyValueSourcePart` and allows interaction with a particular key in the browser's cookie
...
See also: [KeyValueSourcePart](/sources/reference/keyValueSourcePart), [CookieData](/sources/reference/cookieData), [CookieParams](/sources/reference/cookieParams)
