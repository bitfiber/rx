...
Creates an instance of `LocalStoragePart`, allowing interaction with a specific key-value pair
...
See also: [LocalStoragePart](/sources/reference/localStoragePart)
