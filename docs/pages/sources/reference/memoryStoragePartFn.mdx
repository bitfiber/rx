...
Creates an instance of [MemoryStoragePart](/sources/reference/memoryStoragePart), allowing
interaction with a specific key-value pair stored in the memory storage
