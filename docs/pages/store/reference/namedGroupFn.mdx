...
Creates a new `NamedGroup` instance that extracts emitters, states, and groups from the provided
object and adds them to the group. Each item is accessible by the key used in the object.
...
See also: [NamedGroup](/store/reference/namedGroup)
